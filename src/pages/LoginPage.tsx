...
export const LoginPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Login Card */}
      <div className="mt-3 sm:mx-auto sm:w-full sm:max-w-lg relative z-10">
        <div className="bg-slate-900/60 py-4 px-4 shadow-2xl border border-slate-800 sm:rounded-3xl sm:px-8 backdrop-blur-md">
              ...
              {roles.map((r) => {
                ...
                return (
                  <button
                    ...
                    className={`p-2 rounded-xl border text-xs font-semibold transition-all flex flex-col items-center justify-center gap-1 ${
                      isSelected
          ...
          {/* Quick Demo Login */}
          <div className="mb-3 p-2.5 rounded-2xl bg-indigo-950/40 border border-indigo-800/50 flex items-center justify-between gap-3">
            <div>
            ...
            <button
              ...
              disabled={submitting}
              className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-md shadow-indigo-500/20 transition-all shrink-0 flex items-center gap-1 disabled:opacity-50"
            >
              <span>
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-9 pr-3 py-2 border border-slate-800 rounded-xl bg-slate-950 text-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-9 pr-10 py-2 border border-slate-800 rounded-xl bg-slate-950 text-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                />
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-2.5 px-4 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-sm shadow-lg shadow-indigo-500/20 transition-all flex items-center justify-center space-x-2 disabled:opacity-50 mt-2"
            >
              {submitting ? (
