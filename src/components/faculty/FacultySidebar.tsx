...
export const FacultySidebar: React.FC<FacultySidebarProps> = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { label: 'Timetable', path: '/faculty/timetable', icon: CalendarDays },
    { label: 'Notices', path: '/faculty/notices', icon: BellRing },
    ...
    <>
      ...
      >
        ...
        <div className="h-16 px-5 border-b border-slate-800/80 flex items-center justify-between shrink-0">
          <NavLink to="/faculty/dashboard" className="flex items-center space-x-3">
   <div className="w-9 h-9 rounded-xl bg-white border border-slate-700 overflow-hidden flex items-center justify-center shadow-md shadow-indigo-500/20">
  <img
        ...
        <div className="p-4 border-t border-slate-800/80 shrink-0">
          <div className="p-3 rounded-2xl bg-slate-950/60 border border-slate-800 flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[11px] font-bold text-slate-200 truncate">Faculty Authorization</div>
